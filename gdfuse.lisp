...
;; Application files
(defvar app_dir  (filename:concat (os:getenv "HOME") ".gdfuse"))
(defvar config_path (filename:concat app_dir "config"))
(defvar state_path  (filename:concat app_dir "state"))
(defvar log_path  (filename:concat app_dir "log"))
